...
import io.getarrays.server.service.implementation.UserServiceImpl;
...
public class ServerResource {
    ...
    @GetMapping("/ping/{ipAddress}/{port}")
    public ResponseEntity<Response> pingServerPort(@PathVariable("ipAddress") String ipAddress, @PathVariable("port") String port) throws IOException {
        Server server = serverService.pingPort(ipAddress, port);
        return ResponseEntity.ok(
                Response.builder()
                        .timeStamp(now())
                        .data(of("server", server))
    ...
    public ResponseEntity<Response> saveUser(@RequestBody @Valid Users users) {
        return ResponseEntity.ok(
                Response.builder()
                        .timeStamp(now())
                        .data(of("user", userService.create(users)))
